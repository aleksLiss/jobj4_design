...
class QuickListTest {
    ...
    @Test
    public void whenListContainsOnlyNumberWhichAreGreaterThanZero() {
        Comparator<Integer> comparator = (a, b) -> b - a;
        List<Integer> list = new ArrayList<>();
        list.add(1);
        list.add(10);
        ...
        QuickList.quickSort(list, comparator);
        System.out.println(list);
        assertThat(list).containsExactly(10, 8, 1, 1);
    }

    @Test
    public void whenListContainsOnlyNumberWhichAreLessThanZero() {
        Comparator<Integer> comparator = (a, b) -> b - a;
        List<Integer> list = new ArrayList<>();
        list.add(-2);
        list.add(-8);
        ...
        QuickList.quickSort(list, comparator);
        System.out.println(list);
        assertThat(list).containsExactly(-1, -2, -8, -10);
    }
